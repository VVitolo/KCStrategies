    ...
    abstract public class KCAlgoBase : Strategy, ICustomTypeDescriptor
    {
        ...
        protected override void OnStateChange()
        {
            if (State == State.SetDefaults)
            {
				...
				Name										= "KCAlgoBase";
				BaseAlgoVersion								= "KCAlgoBase v5.3";
...
//				step3Frequency					= 2;
		...
		protected override void OnBarUpdate()
        {
			...
			if (EnableChoppinessDetection)
			{
				...
				{
					TransparentColor(96, Colors.LightGray);					
				}
				else
				{
			...
			if (enableBackgroundSignal)
			{
				if (uptrend)
				{				  
					TransparentColor(96, Colors.Lime);
				}
				else if (downtrend)
				{			
					TransparentColor(96, Colors.Crimson);
				}
				else
				{
				    // Reset the background when the condition is false
...
//		[ReadOnly(true)]
        ...
        [NinjaScriptProperty]
        [Range(1, int.MaxValue)]
        [Display(Name = "Bars Timeout", Order = 8, GroupName = "02. Order Settings")]
